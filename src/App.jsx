    ...
    <div className="flex items-center justify-center bg-gray-100 h-screen">
      <div className="flex flex-col gap-6 shadow-lg bg-white rounded-md w-2/5 pt-14 px-8 pb-10">
        ...
        <div className="flex flex-col justify-center items-start gap-4">
          <input type="text" name="" id="" placeholder="Enter a task" className=" text-xl p-2 w-full rounded border border-gray-400" />
          <button className="bg-gray-100 border border-black rounded capitalize px-4 py-1">add task</button>
        </div>
